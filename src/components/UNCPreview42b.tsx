    ...
    >
      ...
      <div className="relative px-[15mm] py-[10mm] h-full flex flex-col">
        ...
        <div className="flex items-start -mt-1">
          <div className="ml-[5mm] flex items-start justify-center" style={{ width: '40mm', marginTop: '-15mm' }}>
            <img src={vdbLogo} alt="VDB" className="object-contain" style={{ width: '40mm', height: '40mm' }} />
          </div>
