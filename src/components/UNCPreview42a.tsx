  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none select-none absolute left-1/2 -translate-x-1/2 w-[160mm] h-[140mm] opacity-20"
        style={{ top: '40mm' }}
      />
      <div className="relative px-[15mm] py-[10mm] h-full flex flex-col">
        ...
        <div className="flex items-start -mt-1">
          <div className="ml-[5mm] flex items-start justify-center" style={{ width: '48mm', marginTop: 'calc(-2rem - 10mm)' }}>
            <img src={vdbLogo} alt="VDB" className="object-contain" style={{ width: '48mm', height: '48mm' }} />
          </div>
